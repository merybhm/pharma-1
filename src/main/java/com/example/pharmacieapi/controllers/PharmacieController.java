...
public class PharmacieController {
	...
	@PostMapping("/add/{user_id}/{nom}/{zone_id}/{adresse}/{lat}/{log}/{telephone}")
	public Pharmacie save(@PathVariable int user_id,
						  @PathVariable String nom,
						  @PathVariable int zone_id,
						  @PathVariable String adresse,
						  @PathVariable Double lat,
						  @PathVariable Double log,
	...
	@GetMapping("/pharmacie/proche/lat={lat}/log={log}")
	public List<Pharmacie> findPharmacieProche(@PathVariable double lat,@PathVariable double log){
		return service.PharmacieProche(lat,log);
	}
